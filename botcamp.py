...
import random
TOKEN: Final='6797079979:AAEMxIE1ZCGgBZD24pnY8155XNEMMOn2VG0'
BOT_USERNAME: Final = '@HuHdembot'
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text('Hello, Welcome to the quiz bot. Type /game to start the quiz.')
...
if __name__ == '__main__':
    ...
    app.add_handler(CommandHandler('game', quiz_command))
